 ...
 * @author hu
 */
public class TutorialExtractor2 {
    ...
    public static class PeopleExtractor extends Extractor {
        ...
        public boolean shouldExecute() {
            ...
            return Pattern.matches("http://hf.ganji.com/fang3/[^/]+", getUrl());
        }
        ...
        public void extract() throws Exception {
            ...
            name = selectText("i[class=fc-gray9]");
            /*如果获取不到，则返回缺省值"未知"*/
            //location = selectText("span.location.item", "未知");
            
            //排除中介
            //isMediation = selectText("i.fc-999");
            
            mobile = selectText("em.contact-mobile", 0, null);
    ...
    public static void main(String[] args) throws Exception {
        ...
        crawler.addSeed("http://hf.ganji.com/fang1");
        crawler.addRegex("http://hf.ganji.com/fang3/[^/]*");
        ...
        crawler.addExtractor("http://hf.ganji.com/fang3/[^/]*", PeopleExtractor.class);
